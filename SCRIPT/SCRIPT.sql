...
insert into VENUEENTITY (ID, CAPACIDADMAX, DIRECCION, NOMBRE, TIPO, CIUDADENTITY_ID, FESTIVALENTITY_ID) values (1001, 201, '309 Claremont Court', 'Elmside', 'ABIERTO', 1001, 1001);
insert into VENUEENTITY (ID, CAPACIDADMAX, DIRECCION, NOMBRE, TIPO, CIUDADENTITY_ID, FESTIVALENTITY_ID) values (1002, 202, '60114 Fordem Drive', 'Carpenter', 'CUBIERTO', 1002, 1002);
insert into VENUEENTITY (ID, CAPACIDADMAX, DIRECCION, NOMBRE, TIPO, CIUDADENTITY_ID, FESTIVALENTITY_ID) values (1003, 203, '9226 Namekagon Parkway', 'Bay', 'CUBIERTO', 1003, 1003);
insert into VENUEENTITY (ID, CAPACIDADMAX, DIRECCION, NOMBRE, TIPO, CIUDADENTITY_ID, FESTIVALENTITY_ID) values (1004, 204, '63077 Fair Oaks Hill', 'Randy', 'CUBIERTO', 1004, 1004);
insert into VENUEENTITY (ID, CAPACIDADMAX, DIRECCION, NOMBRE, TIPO, CIUDADENTITY_ID, FESTIVALENTITY_ID) values (1005, 205, '47 Welch Terrace', 'Mockingbird', 'ABIERTO', 1005, 1005);
